...
class TrainingThread(QThread):
    ...
    def __init__(self, dataset_folder, classes_file, val_ratio, save_dir, model_size, activation, epochs, device, lr0, dropout, batch_size):
        super().__init__()
    ...
    def run(self):
        try:
            ...
            prep_process = subprocess.Popen([sys.executable, "prepare_dataset.py", self.dataset_folder, self.classes_file, self.val_ratio], stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True, bufsize=1, universal_newlines=True)
...
class YOLOv8TrainerUI(QWidget):
    ...
    def start_training(self):
        ...
        self.training_thread = TrainingThread(dataset_folder, classes_file, val_ratio, save_dir, model_size, activation, epochs, device, lr0, dropout, batch_size)
    ...
    def load_settings(self):
        ...
        try:
            ...
            self.device_input.setText(settings.get('device', '0'))
